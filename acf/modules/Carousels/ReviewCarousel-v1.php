    ...
    <section class='ReviewCarousel v1' style="background-color: <?php echo $backgroundColor; ?>;">
        <div class="inner">
            <div class="Carousel reviews" style="background-color: <?php echo $backgroundColor; ?>;" data-autoShift="false">
                <div class="heading">
                    <h3>What our foot<span class="highlight"><span class="background lazyloaded" style="background-image: url(&quot;http://13.40.63.227/wp-content/themes/sokito/assets/images/SOK_Underline_green.svg;&quot;);" data-back="http://13.40.63.227/wp-content/themes/sokito/assets/images/SOK_Underline_green.svg;"></span>ballers</span> say</h3>
                </div>
