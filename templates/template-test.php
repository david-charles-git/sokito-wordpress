...
/**
 * Template Name: Product Results - testing template
...
// echo '<p>' . $active_filter['type'] . ' ' . $active_filter['value'] . '</p>';
                      ...
                      ?>
                        <li class="filterOption" data-value='<?php echo $surface; ?>'>
                          <button onclick="handleFeedFilterOptionClick(event)">
                            ...
                            <p><?php echo $surface === 'firm' ? 'Firm ground' : 'Soft ground'; ?> <span class="count">(<?php echo $data['counts']['surface'][$count]; ?>)</span></p>
                          </button>
                        </li>
                      <?php
                        $count++;
                      ...
                      ?>
                        <li class="filterOption" data-value='<?php echo $size; ?>'>
                          <button onclick="handleFeedFilterOptionClick(event)">
                            ...
                            <p>Size <?php echo $size; ?> <span class="count">(<?php echo $data['counts']['sizes'][$count]; ?>)</span></p>
                          </button>
                        </li>
                      <?php
                        $count++;
                      ...
                      ?>
                        <li class="filterOption" data-value='<?php echo $color; ?>'>
                          <button onclick="handleFeedFilterOptionClick(event)">
                            ...
                            <p><?php echo str_replace('-', ' ', $color); ?> <span class="count">(<?php echo $data['counts']['colors'][$count]; ?>)</span></p>
                          </button>
                        </li>
                      <?php
                        $count++;
                      ...
                      ?>
                        <li class="filterOption" data-value='<?php echo $gender; ?>'>
                          <button onclick="handleFeedFilterOptionClick(event)">
                            ...
                            <p><?php echo $gender; ?> <span class="count">(<?php echo $data['counts']['gender'][$count]; ?>)</span></p>
                          </button>
                        </li>
                      <?php
                        $count++;
                      ...
                      ?>
                        <li class="filterOption" data-value='<?php echo $collection; ?>'>
                          <button onclick="handleFeedFilterOptionClick(event)">
                            ...
                            <p><?php echo str_replace('_', ' ', $collection); ?> <span class="count">(<?php echo $data['counts']['collections'][$count]; ?>)</span></p>
                          </button>
                        </li>
                      <?php
                        $count++;
