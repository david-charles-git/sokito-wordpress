                  ...
                  <div class="filterDropdown">
                    ...
                    <ul class="inner">
                      ...
                      foreach ($data['filters']['surface'] as $surface) {
                        if ($active_filter['type'] == 'surface' && $active_filter['value'] == $surface) {
                          echo '<p style="display: none;">active filter</p>';
                        }
                      ?>
                  ...
                  <div class="filterDropdown">
                    ...
                    <ul class="inner">
                      ...
                      foreach ($data['filters']['sizes'] as $size) {
                        if ($active_filter['type'] == 'sizes' && $active_filter['value'] == $size) {
                          echo '<p style="display: none;">active filter</p>';
                        }
                      ?>
                  ...
                  <div class="filterDropdown">
                    ...
                    <ul class="inner">
                      ...
                      foreach ($data['filters']['colors'] as $color) {
                        if ($active_filter['type'] == 'colors' && $active_filter['value'] == $color) {
                          echo '<p style="display: none;">active filter</p>';
                        }
                      ?>
                  ...
                  <div class="filterDropdown">
                    ...
                    <ul class="inner">
                      ...
                      foreach ($data['filters']['gender'] as $gender) {
                        if ($active_filter['type'] == 'gender' && $active_filter['value'] == $color) {
                          echo '<p style="display: none;">active filter</p>';
                        }
                      ?>
