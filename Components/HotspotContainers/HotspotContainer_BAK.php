...
$imageVariants = [
  ...
  [
    ...
    "imageAlt" => "",
    "swatchBackground" => "linear-gradient(90deg, rgba(0,0,0,1) 50%, rgba(255,255,255,1) 50%)",
    "isVegan" => false
  ],
  [
    "imageSrc" => get_stylesheet_directory_uri() . "/assets/images/sokitoBoot-Devista-redBlack.webp",
    "imageAlt" => "",
    "swatchBackground" => "linear-gradient(90deg, rgba(0,0,0,1) 50%, rgba(255,49,26,1) 50%)",
    "isVegan" => false
  ]
];
...
if ($reviewPosts->have_posts()) {
  while ($reviewPosts->have_posts()) {
    ...
    foreach ($reviewerType as $term) {
      if (
        get_post_meta($reviewID, '_yoast_wpseo_primary_reviewerType', true) == $term->term_id
      ) {
        $primaryType = $term->name;
      }
    }
    ...
    $review["primaryType"] = $primaryType;
                ...
                <div class="inner carouselInner" style="grid-template-columns: repeat(<?php echo $reviewCount; ?>, auto);">
                  ...
                  ?>
                    <div class="reviewCard carouselItem <?php if ($a == 0) {
                      ...
                      if ($allReviews[$a]["primaryType"]) {
                      ?>
                        <p class="tag"><?php echo $allReviews[$a]["primaryType"]; ?></p>
                      <?php
                      } else if ($allReviews[$a]["type"]) {
                      ?>
        ...
        <div class="slider">
          <div class="inner">
            ...
            <div class="hotspots" data-name="materials">
              ...
              ?>
                <div class="hotspot materials <?php if (in_array($a, $veganMaterialsID)) {
                                                echo "isVegan";
