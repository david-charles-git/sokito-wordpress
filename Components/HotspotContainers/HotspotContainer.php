...
$imageVariants = [
  [
    "imageSrc" => get_stylesheet_directory_uri() . "/assets/images/sokitoBoot-Devista-black.webp",
    "imageAlt" => "",
  ...
  [
    "imageSrc" => get_stylesheet_directory_uri() . "/assets/images/sokitoBoot-Devista-blackWithRedTrim.webp",
    "imageAlt" => "",
  ...
  [
    "imageSrc" => get_stylesheet_directory_uri() . "/assets/images/sokitoBoot-Devista-white.webp",
    "imageAlt" => "",
  ...
  [
    "imageSrc" => get_stylesheet_directory_uri() . "/assets/images/sokitoBoot-Devista-blue.webp",
    "imageAlt" => "",
    "swatchBackground" => "linear-gradient(90deg, rgba(37,99,235,1) 0%, rgba(37,99,235,1) 40%, rgba(255,255,255,1) 40%, rgba(255,255,255,1) 60%, rgba(37,99,235,1) 60%)",
    "isVegan" => false,
    "isClassico" => false,
    "isRegular" => true,
  ],
  [
    "imageSrc" => get_stylesheet_directory_uri() . "/assets/images/sokitoBoot-Devista-blackWithYellowTrim.webp",
    "imageAlt" => "",
  ...
  [
    "imageSrc" => get_stylesheet_directory_uri() . "/assets/images/sokitoBoot-Devista-Vegan-white.webp",
    "imageAlt" => "",
  ...
  [
    "imageSrc" => get_stylesheet_directory_uri() . "/assets/images/sokitoBoot-Devista-Vegan-black.webp",
    "imageAlt" => "",
    "swatchBackground" => "linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 40%, rgba(255,49,26,1) 40%, rgba(255,49,26,1) 60%, rgba(0,0,0,1) 60%)",
    "isVegan" => true,
    "isClassico" => false,
  ...
  [
    "imageSrc" => get_stylesheet_directory_uri() . "/assets/images/sokitoBoot-Devista-whiteBlack.webp",
    "imageAlt" => "",
    "swatchBackground" => "linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 40%, rgba(0,0,0,1) 40%, rgba(0,0,0,1) 60%, rgba(255,255,255,1) 60%)",
    "isVegan" => false,
    "isClassico" => false,
    "isRegular" => true,
  ],
  [
    "imageSrc" => get_stylesheet_directory_uri() . "/assets/images/sokitoBoot-Devista-redBlack.webp",
    "imageAlt" => "",
    "swatchBackground" => "linear-gradient(90deg, rgba(255,49,26,1) 0%, rgba(255,49,26,1) 40%, rgba(0,0,0,1) 40%, rgba(0,0,0,1) 60%, rgba(255,49,26,1) 60%)",
    "isVegan" => false,
    "isClassico" => false,
    "isRegular" => true,
  ]
...
$reviewCount = $reviewPosts->found_posts;
$allReviews = [];
...
$averageReviewRating = floatval($averageReviewRating / $reviewCount);
$averageReviewRating = number_format($averageReviewRating, 1);
...
?>
<section id="productHotspotsModule" class="<?php if ($productIsVegan) {
                                              echo "isVegan";
                                            } ?>">
      ...
      <div class="inner">
        ...
        <div class="sizeContainer">
          <div class="currentSize" openClose="open" onclick="handleSizeContainerClick()">
            ...
            <div class="arrowContainer" style="background-image: url(<?php echo get_stylesheet_directory_uri() . "/assets/images/Arrow_black_down.png"; ?>);"></div>
          </div>
          ...
          <div class="sizes">
            <ul>
              ...
              for ($a = 0; $a < count($finalOrderedVariations); $a++) {
                ...
                $isInStock = $finalOrderedVariations[$a]['is_in_stock'];
              ?>
                <li data-variation-id="<?php echo $ID; ?>" data-variation-size="<?php echo $size; ?>" class="size <?php if (!$isInStock) {
                                                                                                                    echo 'outOfStock';
    ...
    <div class="outer">
      <div class="inner">
        ...
        <div class="tab" onclick="handleViewChange(this)" data-name="reviews">
          <!-- <p class="">Reviews (<span id="reviewContainer"><?php //echo $reviewCount; 
                                                                ?></span>)</p> -->
          <p class="">Reviews (<span id="reviewContainer">216</span>)</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="inner">
          ...
          <div class="inner">
            ...
            ?>
              <p style='margin-bottom: 20px;'>
                Sokito wanted to create a boot that would stand the test of time, one that would perform just as well as the original Devista but give people the option to cut out animal produce from both their diet and their wardrobe. This boot gives vegan-conscious players peace of mind, knowing their values are being upheld.
              </p>
            <?php
            }
            ?>
            ...
            <?php if ($isClassico) { ?>
              ...
              <p>We’ve reincarnated a classic style: with a modern twist. The Classico gives strikers the ultimate control on their shots, whilst still being made from at least 56% eco-friendly materials.</p>
        ...
        <div class="details" data-name="materials">
          <div class="inner">
            ...
            ?>
            <p>
              Take a look through the materials we're currently using for the Devista, and the innovative changes we're looking to make in the future. Even though we're already the most eco-friendly boots, we're always wanting more ways to make our boots 100% sustainable.
            </p>
          </div>
        </div>
          ...
          <div class="inner">
            <div class="ratingCotnainer">
              ...
              <div class="countContainer">
                <!-- <p>Based on <?php //echo $reviewCount; 
                                  ?> reviews</p> -->
                <p>Based on 216 reviews</p>
            ...
            <div class="reviewsCarousel" id="hotspotReviewCarousel">
              ...
              <div class="outer" ontouchstart="handleReviewCarouselTouchStart()" ontouchend="handleReviewCarouselTouchEnd()" ontouchcancel="handleReviewCarouselTouchEnd()">
                <div class="inner carouselInner" style="grid-template-columns: repeat(<?php echo $reviewCount; ?>, auto);">
                  ...
                  ?>
                    <div class="reviewCard carouselItem <?php if ($a == 0) {
                                                          echo "active";
                                                        } ?>">
                      <?php
                      ...
                      if ($allReviews[$a]["type"]) {
                        if ($allReviews[$a]["type"][0]->name == "home page item" && $allReviews[$a]["type"][1]) {
                        ?>
                          <p class="tag"><?php echo $allReviews[$a]["type"][1]->name; ?></p>
                        <?php
                        } else {
                        ?>
              ...
              <div class="tabContainer" style="grid-template-columns: repeat(<?php echo $reviewCount; ?>,auto);">
                ...
                ?>
                  <div data-id="<?php echo $a; ?>" class="naigationTab <?php if ($a == 0) {
                                                                          echo "active";
                                                                        } ?>" onclick="handleReviewCarouselNaviagationTabClick()"></div>
                <?php
                }
                ?>
              </div>
      ...
      <div class="inner">
          ...
          <div class="inner">
            <div class="imageContainer">
              <div class="image">
                ...
                ?>
                  <img class="<?php if ($a === $initlaActiveIndex) {
                                echo "active ";
                              }
                              if ($imageVariants[$a]["isVegan"]) {
                                echo "isVegan";
                              } ?>" src="<?php echo $imageVariants[$a]["imageSrc"]; ?>" alt="<?php echo $imageVariants[$a]["imageAlt"]; ?>" data-id="<?php echo $a; ?>" />
                <?php
                }
                ?>
              </div>
            ...
            <div class="hotspots" data-name="materials">
              ...
              for ($a = 0; $a < $materialCount; $a++) {
                ...
                if (in_array($a, $veganMaterialsID) && $productIsVegan) {
                  $display = 'none';
                  if (($postID == '1103')) {
                    $display = 'block';
                  }
              ...
              ?>
                <div style="display: <?php echo $display; ?>" class="hotspot materials <?php if (in_array($a, $veganMaterialsID)) {
                                                                                          echo "isVegan";
                                                                                        } ?>" data-id="materials-<?php echo $a; ?>" onmouseenter="showHotspotCardHover(this)" onmouseleave="handleMouseLeave()" onclick="showHotspotCardClick(this)"></div>
              <?php
              }
              ?>
            </div>
        ...
        <div class="contentContainer right">
          ...
          <div class="contentGroup" data-name="materials">
            ...
            <div class="content materials isVegan" data-id="materials-13">
              <div class="inner">
                <h5 class=""><span>Recycled</span> Vegan Upper</h5>

                <p>The Devista Vegan upper, and parts of the Devista, are made from recycled carpet. Vegan approved, it mimics the touch and strength of traditional leather, whilst staying soft to mold to the feet. Produced with 35% pre-consumer recycled nylon and 10% post-consumer recycled nylon (remaining 55% PU), it makes use of waste carpet, so that scruffy old thing in your nan’s house can be subbed back in.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="colorSwitchContainer">
          ...
          ?>
            <div class="colorSwitch <?php if ($a === 0) {
                                      echo "active ";
                                    }
                                    if ($imageVariants[$a]["isVegan"]) {
                                      echo "isVegan";
                                    }
                                    if ($imageVariants[$a]["isClassico"]) {
                                      echo "isClassico";
                                    }
                                    if ($imageVariants[$a]["isRegular"]) {
                                      echo "isRegular";
                                    }
                                    ?>" onclick="handleColorSwicth(this)" data-id="<?php echo $a; ?>">
...
<style>
  ...
  #productHotspotsModule>.detailsContainer>.outer>.inner>.details>.inner p span.tick::before {
    ...
    content: "";
    margin-right: 10px;
    background-image: url("<?php echo get_stylesheet_directory_uri() . "/assets/images/Icon\ ionic-ios-checkmark-orange.svg"; ?>");
  ...
  #productHotspotsModule>.hotspotContainer>.outer>.inner>.slider>.inner>.hotspots>.hotspot.isVegan {
    display: none;
  }
  ...
  #productHotspotsModule>.hotspotContainer>.outer>.inner>.slider>.inner>.hotspots>.hotspot.materials:nth-child(14) {
    top: 180px;
    left: 600px;
  }
  ...
  #productHotspotsModule>.hotspotContainer>.outer>.inner>.contentContainer>.contentGroup>.content.isVegan {
    display: none;
  }
...
<script>
  function handleHotspotAddToBagClick() {
    ...
    if (!eventTarget || !hotSpotProductVariationIDCotnainer) {
      return;
    }
  ...
  function showHotspotCardHover(elmt = null) {
    ...
    if (!elmt || !hotspotContainer || window.innerWidth <= mobilScreeBreak) {
      return;
    }
  ...
  function showHotspotCardClick(elmt = null) {
    ...
    if (!elmt || !hotspotContainer || window.innerWidth > mobilScreenBreak) {
      return;
    }
  ...
  function handleMouseLeave() {
    ...
    if (window.innerWidth <= mobilScreeBreak) {
      return;
    }
  ...
  function handleViewChange(elmt = null) {
    ...
    for (var a = 0; a < tabArray.length; a++) {
      ...
      if (tabName === elmtName) {
        tabArray[a].classList.add("active");
      }
