...
?>
      ...
      <div class='left'>
        <div class='inner <?php echo $leftColumnType; ?>'>
          ...
          ?>
              ...
              if ($leftTextCtaHref && $leftTextCtaText) {
              ?>
              ...
              <div class="listContainer">
                <ul>
                  ...
                  ?>
                      <li>
                        <?php
                        if ($leftListItemTitle) {
                        ?>
                          <h3><?php echo $leftListItemTitle; ?></h3>
                        <?php
                        }

                        if ($leftListItemContent) {
                        ?>
      ...
      <div class='right'>
        <div class='inner <?php echo $rightColumnType; ?>'>
          ...
          ?>
              ...
              if ($rightTextCtaHref && $rightTextCtaText) {
              ?>
                <button class="roundedButton">
              ...
              <div class="listContainer">
                <ul>
                  ...
                  ?>
                      <li>
                        <?php
                        if ($rightListItemTitle) {
                        ?>
                          <h3><?php echo $rightListItemTitle; ?></h3>
                        <?php
                        }

                        if ($rightListItemContent) {
                        ?>
  ...
  <!-- <link rel="stylesheet" type='text/css' href="<?php echo get_stylesheet_directory_uri(); ?>/Components/TwoColumn/TwoColumn.css" /> -->
  ...
  <!-- <style>
    ...
    .TwoColumn>.inner>.left>.inner.text>p>a,
    .TwoColumn>.inner>.right>.inner.text>p>a {
      font-weight: 700;
      transition: color .2s ease;
    }

    .TwoColumn>.inner>.left>.inner.text>p>a:hover,
    .TwoColumn>.inner>.right>.inner.text>p>a:hover {
      color: #fc4f00;
    }
    ...
    .TwoColumn>.inner>.left>.inner.list>.listContainer>ul>li>p>a,
    .TwoColumn>.inner>.right>.inner.list>.listContainer>ul>li>p>a {
      font-weight: 700;
      transition: color .2s ease;
    }

    .TwoColumn>.inner>.left>.inner.list>.listContainer>ul>li>p>a:hover,
    .TwoColumn>.inner>.right>.inner.list>.listContainer>ul>li>p>a:hover {
      color: #fc4f00;
    }
    ...
    @media (max-width: 880px) {
      ...
      .TwoColumn>.inner>.left>.inner.text>h2 span,
      .TwoColumn>.inner>.right>.inner.text>h2 span {
        font-size: inherit;
      }
