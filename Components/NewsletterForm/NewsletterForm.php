<?php
$formShortCode = "[gravityform id='7' title='false' ajax='true']"; //6 DEV | 7 PROD
$backgroundImage = get_stylesheet_directory_uri() . "/assets/images/liveCoveragesArticles-backgroundIamge.webp";
?>
...
<script>
    function handleNewsletterFormSubmission() {
        ...
        const submissionForm = document.getElementById("gform_7");
        ...
        const submissionFormEmailInput = document.getElementById("input_7_1");
        const userEmail = form.getElementsByClassName("userEmail")[0];

        if (!emailContainer || !submissionFormEmailInput || !userEmail) {
            return;
        }
