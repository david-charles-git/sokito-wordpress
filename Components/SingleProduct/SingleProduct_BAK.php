...
body .outOfStockNotificationPopUp>.outer>.inner>.content>.form>.inner>.emailContainer>input, .bisInput{
  font-family: 'Gza';
    font-size: 16px;
    line-height: 1.1;
    letter-spacing: 0;
                    ...
                    ?>
                      <div data-hasBackOrder="<?php echo $hasBackOrder; ?>" data-backOrderRangeStart="<?php echo $backOrderRangeStartDate; ?>" data-backOrderRangeEnd="<?php echo $backOrderRangeEndDate; ?>" data-variation-id="<?php echo $ID; ?>" data-variation-size="<?php echo $size; ?>" class="size <?php if (!$isInStock && !$hasBackOrder) {
                        ...
                        <?php if($hasBackOrder === true){
                          echo '<span style="border-left: 1px solid #D8D8D8; border-bottom: 1px solid #D8D8D8; border-right: 1px solid #D8D8D8; position:absolute; bottom:0px; left:0px; width:100%; background:#D8D8D8; font-size:8px; text-align:center; line-height:15px; display:block; ">pre-order</span>';
                        } ?>
...
<script>
  ...
  function handlePopUpClose() {
    ...
    $('.showIfConfirmed').hide();
    $('.hideIfConfirmed').show();
  ...
  function ajax_addToCard(ID = 0, SKU = 0, quantity = 0, variableID = 0) {
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        // Item was added to cart, add to ecomm datalayer
