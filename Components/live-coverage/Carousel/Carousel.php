...
?>
        <section class="Carousel" data-autoShift="true">
            <div class="outer">
                ...
                <div class="inner" style="grid-template-columns: repeat(<?php echo count($carouselItems); ?>, auto);" ontouchstart="handleCarouselTouchStart()" ontouchend="handleCarouselTouchEnd()" ontouchcancel="handleCarouselTouchEnd()">
<?php
...
?>
                                    <div class="iframeContainer" onclick="handleStopCarouselAutoShift()">
                                        <iframe src="<?php echo $carouselItems[$a]["embedURL"]; ?>" onclick="handleStopCarouselAutoShift()"></iframe>
                                    </div>
<?php   
                                }
?>
...
?>
            ...
            <div class="tabContainer" style="grid-template-columns: repeat(<?php echo count($carouselItems); ?>,auto);">
<?php
                for ($a = 0; $a < count($carouselItems); $a++) {
?>
                    <div data-id="<?php echo $a; ?>" class="naigationTab <?php if ($a == 0) { echo "active"; } ?>" onclick="handleCarouselNaviagationTabClick()"></div>
<?php
                }
?>
            </div>
